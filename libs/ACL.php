...
class ACL
{
	...
	public static $role_pages = array(
			'admin' =>
						array(
							'vsla_groups' => array('list','view','add','edit', 'editfield','delete','import_data'),
							'vsla_members' => array('list','view','add','edit', 'editfield','delete','import_data'),
							'users' => array('list','view','userregister','accountedit','accountview','add','edit', 'editfield','delete','import_data'),
							'loans' => array('list','view','add','edit', 'editfield','delete','import_data'),
							'roles' => array('list','view','add','edit', 'editfield','delete','import_data'),
							'loan_application' => array('list','view','add','edit', 'editfield','delete','import_data'),
							'loan_payment' => array('list','view','add','edit', 'editfield','delete','import_data'),
							'monitoring' => array('list','view','add','edit', 'editfield','delete'),
							'staff' => array('list','view','add','edit', 'editfield','delete')
						),
		
			'user' =>
						array(
							'vsla_groups' => array('list'),
							'vsla_members' => array('list'),
							'loans' => array('list','import_data'),
							'loan_application' => array('list','import_data'),
							'loan_payment' => array('list','import_data'),
							'monitoring' => array('list'),
							'staff' => array('list')
						)
		);
