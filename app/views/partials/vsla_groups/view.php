...
<section class="page ajax-page" id="<?php echo $page_element_id; ?>" data-page-type="view"  data-display-type="table" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title"><?php print_lang('view_vsla_groups'); ?></h4>
                </div>
            </div>
        </div>
    </div>
                            ...
                            <table class="table table-hover table-borderless table-striped">
                                ...
                                <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                    <tr  class="td-vsla_id">
                                        ...
                                        <td class="value"> <?php echo $data['vsla_id']; ?></td>
                                    </tr>
                                    <tr  class="td-District">
                                        <th class="title"> <?php print_lang('district'); ?>: </th>
                                        <td class="value"> <?php echo $data['District']; ?></td>
                                    </tr>
                                    <tr  class="td-Cluster">
                                        <th class="title"> <?php print_lang('cluster'); ?>: </th>
                                        <td class="value"> <?php echo $data['Cluster']; ?></td>
                                    </tr>
                                    <tr  class="td-Village">
                                        <th class="title"> <?php print_lang('village'); ?>: </th>
                                        <td class="value"> <?php echo $data['Village']; ?></td>
                                    </tr>
                                    <tr  class="td-Vsla">
                                        <th class="title"> <?php print_lang('vsla'); ?>: </th>
                                        <td class="value"> <?php echo $data['Vsla']; ?></td>
                                    </tr>
                                </tbody>
                                <!-- Table Body End -->
                            </table>
