...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="list"  data-display-type="table" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container-fluid">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title"><?php print_lang('vsla_members'); ?></h4>
                </div>
                <div class="col-sm-3 ">
                    <?php if($can_add){ ?>
                    <a  class="btn btn btn-primary my-1" href="<?php print_link("vsla_members/add") ?>">
                        <i class="fa fa-plus"></i>                              
                        <?php print_lang('add_new_vsla_members'); ?> 
                    </a>
                    <?php } ?>
                </div>
                <div class="col-sm-4 ">
                    <form  class="search" action="<?php print_link('vsla_members'); ?>" method="get">
                            ...
                            <nav class="page-header-breadcrumbs mt-2" aria-label="breadcrumb">
                                <ul class="breadcrumb m-0 p-1">
                                    ...
                                    <li class="breadcrumb-item">
                                        <a class="text-decoration-none" href="<?php print_link('vsla_members'); ?>">
                ...
                <div class="row ">
                    <div class="col-md-12 comp-grid">
                        ...
                        <div  class=" animated fadeIn page-content">
                            <div id="vsla_members-list-records">
                                    ...
                                    <table class="table  table-striped table-sm text-left">
                                        <thead class="table-header bg-light">
                                            <tr>
                                                ...
                                                <th  class="td-Sex"> <?php print_lang('sex'); ?></th>
                                                <th  class="td-Maritalstatus"> <?php print_lang('maritalstatus'); ?></th>
                                        ...
                                        <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                            ...
                                            <tr>
                                                ...
                                                <td class="td-mem_id"> <?php echo $data['mem_id']; ?></td>
                                                <td class="td-Name"> <?php echo $data['Name']; ?></td>
                                                <td class="td-Age"> <?php echo $data['Age']; ?></td>
                                                <td class="td-Sex"> <?php echo $data['Sex']; ?></td>
                                                <td class="td-Maritalstatus"> <?php echo $data['Maritalstatus']; ?></td>
                                                <td class="td-Telephone"><a href="<?php print_link("tel:$data[Telephone]") ?>"><?php echo $data['Telephone']; ?></a></td>
                                                <td class="td-District"> <?php echo $data['District']; ?></td>
                                                <td class="td-Cluster"> <?php echo $data['Cluster']; ?></td>
                                                <td class="td-Village"> <?php echo $data['Village']; ?></td>
                                                <td class="td-Vsla"> <?php echo $data['Vsla']; ?></td>
                                                <td class="td-vsla_id"> <?php echo $data['vsla_id']; ?></td>
                                            </tr>
                                            <?php 
                                            }
                                            ?>
                                                        ...
                                                        <a class="dropdown-item export-link-btn" data-format="print" href="<?php print_link($export_print_link); ?>" target="_blank">
                                                            ...
                                                            <a class="dropdown-item export-link-btn" data-format="pdf" href="<?php print_link($export_pdf_link); ?>" target="_blank">
                                                                ...
                                                                <a class="dropdown-item export-link-btn" data-format="word" href="<?php print_link($export_word_link); ?>" target="_blank">
                                                                    ...
                                                                    <?php Html :: import_form('vsla_members/import_data' , get_lang('import_data'), 'CSV'); ?>
                                                                </div>
                                                            </div>
                                                            <div class="col">   
                                                                <?php
