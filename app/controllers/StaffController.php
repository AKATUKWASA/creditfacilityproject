...
class StaffController extends SecureController{
	...
	function index($fieldname = null , $fieldvalue = null){
		...
		$page_title = $this->view->page_title = get_lang('staff');
	...
	function view($rec_id = null, $value = null){
		...
		if($record){
			$page_title = $this->view->page_title = get_lang('view_staff');
		$this->view->report_filename = date('Y-m-d') . '-' . $page_title;
		$this->view->report_title = $page_title;
		$this->view->report_layout = "report_layout.php";
		$this->view->report_paper_size = "A4";
	...
	function add($formdata = null){
		if($formdata){
			...
			$request = $this->request;
			//fillable fields
			$fields = $this->fields = array("id","Name","Title","email","Telephone","img");
		...
		$page_title = $this->view->page_title = get_lang('add_new_staff');
	...
	function edit($rec_id = null, $formdata = null){
		...
		$page_title = $this->view->page_title = get_lang('edit_staff');
		if(!$data){
			$this->set_page_error();
		}
